...
Versions are tagged in git as `v0.1.0-alpha`, `v0.9.0-beta`, `v0.9.5-beta`. The unreleased section captures the work happening on the `v1.0.5-fixture-rewrite` branch toward the first community release.
