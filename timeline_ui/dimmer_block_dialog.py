...
class DimmerBlockDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.effect_type_combo.addItems(["static", "hit", "pulse", "pulse_staggered", "twinkle", "strobe", "ping_pong_smooth", "random_strobe", "snake", "zigzag", "waterfall_down", "waterfall_up"])
